  ...
  public: {
    Tables: {
      ...
      work_ticket_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "work_ticket_items_work_ticket_id_fkey";
    ...
    Functions: {
      sync_work_ticket_status: { Args: { p_work_ticket_id: string }; Returns: undefined };
      has_role: {
        Args: {
    ...
    Enums: {
      app_role: "administrator" | "production_manager" | "production_operator" | "store_keeper" | "management";
      batch_status: "active" | "depleted" | "quarantined";
      cycle_count_status: "draft" | "in_progress" | "completed" | "cancelled";
      job_status: "draft" | "pending" | "approved" | "in_production" | "completed" | "cancelled";
      offcut_status: "available" | "reserved" | "used" | "scrapped";
      plate_status: "available" | "reserved" | "partially_used" | "fully_consumed";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
